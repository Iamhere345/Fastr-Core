...
remotes.ShowSmallMessage.OnClientEvent:Connect(function(msg,player,duration)
	...
	local tween = TweenService:Create(message,TweenInfo.new(0.5),{BackgroundTransparency = 0.45,TextTransparency = 0})
	...
	local tween2 = TweenService:Create(message,TweenInfo.new(0.5),{BackgroundTransparency = 1,TextTransparency = 1})
...
remotes.ShowCountdown.OnClientEvent:Connect(function(Time)
	...
	local tween = TweenService:Create(countdown,TweenInfo.new(0.5),{BackgroundTransparency = 0.45,TextTransparency = 0})
	...
	local tween2 = TweenService:Create(countdown,TweenInfo.new(0.5),{BackgroundTransparency = 1,TextTransparency = 1})
