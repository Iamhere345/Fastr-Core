...
Settings.SoftLoad = true --setting this to false will mean that if you have a bigger game you may expirience some lag for a few seconds. setting this to true will mean that fastr will load a bit slower, but there will be no lag
